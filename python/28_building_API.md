 ...
 * [breed API](https://api.thecatapi.com/v1/breeds)

Postman is a very popular tool when it comes to API development. So we will be using Postman, an alternative Insomnia.
[[postman_info]]
...
```
Let us build an API which collects information about thirty_days_of_python students. We will collect the name, country, city, date of birth, skills and bio.
